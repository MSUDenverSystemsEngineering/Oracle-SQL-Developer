...
Try {
	...
	[string]$appVersion = '22.2.1'
	[string]$appArch = 'x86/x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '10/03/2022'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		If (Test-Path "$envCommonStartMenuPrograms\Oracle SQL Developer.lnk") {
			Write-Log -Message "Deleting start menu shortcut..." -Source 'Pre-Installation' -LogType 'CMTrace'
			Remove-Item "$envCommonStartMenuPrograms\Oracle SQL Developer.lnk" -Force
		}
		If (Test-Path "$env:ProgramData\Microsoft\Windows\Start Menu\Programs\Oracle SQL Developer.lnk") {
			Write-Log -Message "Deleting start menu shortcut..." -Source 'Pre-Installation' -LogType 'CMTrace'
			Remove-Item "$env:ProgramData\Microsoft\Windows\Start Menu\Programs\Oracle SQL Developer.lnk" -Force
		}
		...
		Copy-Item -Path "$dirSupportFiles\Oracle SQL Developer.lnk" -Destination "$env:ProgramData\Microsoft\Windows\Start Menu\Programs"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUjxzNOqsfBL9G+exYDvc126yQ
# ImKgghHXMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# MRYEFPuvjC7bzPhs50/IY02UTyG9aVldMA0GCSqGSIb3DQEBAQUABIIBgEBW3d/n
# nGjHI/XT/+qr7MZ7U5tjem3w+Hr51Zsfd2oxx1n/xcTgvWuRs9liWTAqKi8EDkpc
# KsxF9Y9JQZtcqa7n6lwioqq07+5MxZ9mjukqSgeuJviHFvFTbH6j+BOVWSg/2DF/
# +ZK2B4m/x8F1pRZOCVuuIUB6cc+8cGlVQDqYPUPY3H5vM5Iqt8JV6ME6veTWOzrZ
# DnukPLu6fjzvHi2fy06IvxnSFLuZGrxStuegJXuv3ZrLAsNMEt3CSmT24fO8/VuE
# PzW6EDsiRGB2aDfa5RNIRbz3ehzwunDXgTFdJY2QM9l3VfMgb3Dbo5OiIi8LOXk+
# ihPqwGLuuA6xR9dJvuq1AEq4OVvm4kmh9DhM70gzU1N5twid5KB8pNUnFT1l61dh
# QK17d81y5rtEQ04KKI+Jtladpg9jwxSlM78kWQSe6d4HwFKRdi78e/VfrTOiVXNp
# /xH7IaWXYGY7IsZXJEPOWj3FZVOHRlu2E2LaWUQWq5XD7JIFYIR0N254Qg==
